...
lfw_people = fetch_lfw_people(min_faces_per_person=70, resize=0.4,color=False,funneled=False,slice_=(slice(0,250),slice(0,250)))
...
#With the help of the shape of original image, we will reshape a 1 d array image into 2 d matrices(images)
